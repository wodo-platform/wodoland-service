...
export class DemoController {
  ...
  @ApiResponse({
    status: 201,
    description: 'The demo has been successfully updated.',
  })
  @ApiResponse({ status: 403, description: 'Forbidden.' })
  @Put()
  async updateDemo(
  ...
  @ApiParam({
    name: 'id',
    description:
      'Unique numeric demo id generated by the system for the demo entities.',
    required: false,
    allowEmptyValue: false,
  })
  @ApiResponse({
    status: 200,
    description: 'Return demo found by the given id.',
  })
  @Get(':id')
