...
The main repository contains all business logic implementations, communication services/transports (REST, websockets), and persistency operations. The service is initially implemented in a monolithic fashion to drive PoC cases. It will be shaped into micro-services progressively.
